...
import { ListWokflows } from "../../../src/api/ListWokflows";
...
describe("List workflows handler", () => {
    describe("process method", () => {
        ...
        it("should list workflows", async () => {
            ...
            ListWokflows.ListWokflows = jest.fn((session) => {
                fakeSession = session;
                return {
                    success: true,
            ...
            expect(ListWokflows.ListWokflows).toHaveBeenCalledTimes(1);
            expect(ListWokflows.ListWokflows).toHaveBeenCalledWith(
                fakeSession,
                workflowName,
                category,
                system,
